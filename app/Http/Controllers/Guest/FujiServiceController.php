...
class FujiServiceController extends Controller
{
    ...
    public function serviceReport($id)
    {
        ...
        return view('guest.fuji_service.service_report',
    ...
    public function headRepairReport($id)
    {
        ...
        $fuji_service->save();
        $list = Fuji_service_detail::where('fuji_service_id', $id)->get();
        return view('guest.fuji_service.head_repair_report',
            ['fuji_service'=>$fuji_service,
            'list' => $list]);
    }
    ...
    {   
        ...
        return view('guest.fuji_service.create',
    ...
    public function edit($id)
    {
        ...
        return view('guest.fuji_service.edit',[
                'head_types'=>$this->_cates,
                 'parts'=>$parts,
                'list' => $list,
                'fuji_service' => $fuji_service,
    ...
    public function serviceReportPDF ($id) 
    {
        ...
        $fuji_service->save();
        $list = Fuji_service_detail::where('fuji_service_id', $id)->get();
        $pdf=PDF::loadView('guest.fuji_service.service_report_pdf',
                          ['fuji_service'=>$fuji_service,
                                  'list' => $list]);
