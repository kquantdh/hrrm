...
@section('content')
    ...
    {!! Form::model($fuji_service, ['method'=>'PUT','files'=>'true','url'=>['admin/fujiservice/create/edit_copy_more_service',$fuji_service->id], 'role'=>'form']) !!}
    @include('admin.fuji_service.form.form_edit_copy_more_service')
    {!! Form::close() !!}
