                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="btn-group">
                                                <a href="{{ url('home/outstock/reset_create') }}" id="sample_editable_1_2_new" class="btn sbold green"> Add New
                                                    <i class="fa fa-plus"></i>
                                                </a>
                                            </div>
                                        </div>
                                       <!-- <div class="col-md-6">
                                            {!! Form::open(['method'=>'GET','url'=>'home/outstock']) !!}
                                        ...
                                        @foreach($out_stocks as $item)
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="width: 210px;width:21%"  >
                                                    {!! Form::open(['method'=>'POST','url'=>['home/outstock/change_status',$item->id]]) !!}
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a data-toggle="modal" data-target="#large" href="{{url('home/out-and-return-stock-detail/detail/'.$item->id)}}">
                                                                    <i class="fa fa-file-pdf-o"></i> Show </a>
                                                            </li>
                                                            @if($item->status == 3)
                                                                <li>
                                                                    <a href="{{url('home/getoutstock/'.$item->id)}}">
                                                                        <i class="fa fa-file-pdf-o"></i> Edit Outstock </a>
                                                                </li>
                                                        @endif

                                                        <!-- <li>
                                                        <a href="{{url('home/outstock/delete/'.$item->id)}}">
                                                            <i class="fa fa-file-pdf-o"></i> Delete Outstock </a>
                                                    </li> -->
                                                            <li>
                                                                <a href="{{url('home/outstock/out_stock_pdf/'.$item->id)}}">
