        ...
        <div class="container">
                                        ...
                                        <div class="col-md-6"> 
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-2 col-sm-2 col-md-2 text-center">
                                                        <a href="{{ url('admin/fujiservice/create') }}" id="sample_editable_1_2_new" class="btn sbold green"> PDF
                                                        </a>
                                                    </div>
                                                </div>
                                        </div>
            ...
            <table style="width:100%;border-style:none;" >
                <tr >
                    ...
                    <td colspan="4" style="font-weight:bold;font-size:25px;color: #394260;border-style:none;padding:2px;text-align: center">FUJI
                        MACHINE VIETNAM CO., LTD.</td>
            
                </tr>
                <tr>
                    <td colspan="6" rowspan="3" style="color: #394260;font-weight:bold; padding-left:100px;border-style:none;text-align: left">1st and
